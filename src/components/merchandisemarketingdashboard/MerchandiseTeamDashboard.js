...
const Indent = React.lazy(() =>
  import("../admindashboard/indent/Indent")
);
...
const Stock = React.lazy(() =>
  import("../admindashboard/stock/Stock")
);
const MerchandiseTeamDashboard = () => {
  ...
  const navItems = [
    ...
    { path: "/merchandise/partner", label: "Partner" },
    { path: "/merchandise/material-data", label: "Material Data" },
    { path: "/merchandise/work-order", label: "Work Order" },
    { path: "/merchandise/proforma-invoice", label: "Proforma Invoice" },
      ...
      children: [
        {
          id: "partners",
          label: "Partners",
          path: "/merchandise/partners",
          icon: Users,
        },
        {
          id: "materialData",
          label: "Material Data",
          path: "/merchandise/material-data",
          icon: Box,
        },
      ],
    },
