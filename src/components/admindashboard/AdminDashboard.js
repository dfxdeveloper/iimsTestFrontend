...
const PurchaseOrders = React.lazy(() =>
  import("./purchaseorder/PurchaseOrders")
);
...
const AdminDashboard = () => {
  ...
  const navItems = [
    ...
    { path: "/admin/dashboard/partners", label: "Partners" },
    { path: "/admin/dashboard/purchase-orders", label: "Purchase Orders" },
    { path: "/admin/dashboard/organizations", label: "User Creation" },
  ...
  const sidebarItems = [
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          id: "materialData",
          label: "Material Data",
          path: "/admin/dashboard/material-data",
          icon: Box,
        },
      ],
    },
    {
      ...
      path: "/admin/dashboard/proformainvoice",
      icon: FileText,
    },
    {
      id: "indent",
      label: "Indent",
      path: "/admin/dashboard/indent",
      icon: ClipboardList,
    },
    {
      id: "orders",
        ...
        <div className="flex-1 overflow-auto p-6 bg-gray-50 dark:bg-gray-900">
          ...
          >
            <Routes>
              ...
              <Route path="dashboard/work-order" element={<WorkOrder />} />
              <Route
              ...
              />
              <Route path="dashboard/indent" element={<Indent />} />
              <Route
                path="*"
                element={<Navigate to="/admin/dashboard" replace />}
              />
