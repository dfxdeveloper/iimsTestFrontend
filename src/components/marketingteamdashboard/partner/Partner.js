      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div className="flex gap-2">
          <div className="relative">
            ...
            <input
              ...
              className="w-full sm:w-48 md:w-64 pl-10 pr-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
            />
          </div>
        </div>
        <div className="flex flex-wrap items-center gap-4">
          <button
            ...
            className="flex items-center gap-2 bg-[#636AE8] hover:bg-blue-500 text-white px-4 py-2 rounded-lg transition-colors duration-200"
          >
            <Plus size={20} />
            Add New Partner
          </button>
